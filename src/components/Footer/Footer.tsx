const Footer = () => {
  return (
    <footer className=" flex flex-col bg-darkBrown rounded-t-3xl mt-16 w-screen overflow-hidden">
        <div className="  flex md:flex-row flex-col mt-12 text-white items-start pl-20">
        <div className=" basis-2/3 flex md:flex-row w-full  flex-col">
            <div className=" basis-1/4">
                <div className=" text-white font-extrabold text-2xl">Privacy</div>
                <div className=" text-gray-400 text-lg font-medium">
                    <div className=" block mt-4"> Terms of use</div>
                    <div className=" block mt-4"> Privacy Policy</div>
                    <div className=" block mt-4"> Cookies</div>
                </div>
            </div>
            
            <div className=" basis-1/4 md:mt-0 mt-8">
                <div className="privacy text-white font-extrabold text-2xl">Services</div>
                <div className=" text-gray-400 text-lg font-medium">
                    <div className=" block mt-4 cursor-pointer"> Shop</div>
            ...
            <div className=" basis-1/4 md:mt-0 mt-8">
                ...
                <div className=" text-gray-400 text-lg font-medium">
                    <div className=" block mt-4 cursor-pointer"> Find a location</div>
            ...
            <div className=" basis-1/4 md:mt-0 mt-8">
                ...
                <div className=" text-gray-400 text-lg font-medium">
                    <div className=" block mt-4 cursor-pointer">Plans and Pricing</div>
                    <div className=" block mt-4 cursor-pointer">Jobs</div>
                    <div className=" block mt-4 cursor-pointer"> Sell Your Product</div>
                </div>
            </div>
          </div>
        <div className="social-media basis-2/6 md:mt-0 mt-8">
